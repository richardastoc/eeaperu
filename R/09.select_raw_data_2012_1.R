#' Selecciona datos solo de 2012, por diferencia del resto
#'
...
#'
#' @examples
#' select_2012_1(eea_data_links_variables_df_manual,eea_raw_data)
select_2012_1=function(eea_data_links_variables_df_manual,
...
#write_rds(datos_ventas1,'ventas_2012.rds')
#write_rds(datos_insumos1,'insumos_2012.rds')
#write_rds(datos_resultados1,'resultados_2012.rds')
#write_rds(datos_acfijo1,'activo_fijo_2012.rds')
#write_rds(datos_activos1,'activo_contable_2012.rds')
#write_rds(datos_impuesto1,'impuesto_2012.rds')
#write_rds(datos_intangibles1,'intangibles_2012.rds')
#write_rds(datos_publicidad1,'publicidad_2012.rds')
