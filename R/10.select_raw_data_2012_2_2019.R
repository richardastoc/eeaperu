#' Selecciona datos de 2012 a 2019, tambien por semejanza, no es admisible tilde
#'
...
#'
#' @examples
#' select_2012_2019(eea_data_links_variables_df_manual,eea_raw_data)
select_2012_2019=function(eea_data_links_variables_df_manual,
...
# write_rds(datos_ventas1,'ventas_2019.rds')
# write_rds(datos_insumos1,'insumos_2019.rds')
# write_rds(datos_resultados1,'resultados_2019.rds')
# write_rds(datos_acfijo1,'activo_fijo_2019.rds')
# write_rds(datos_activos1,'activo_contable_2019.rds')
# write_rds(datos_impuesto1,'impuesto_2019.rds')
# write_rds(datos_intangibles1,'intangibles_2019.rds')
# write_rds(datos_publicidad1,'publicidad_2019.rds')
